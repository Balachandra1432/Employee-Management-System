...
-- INSERTING VALUES INTO THE REGION table
...
-- insertng values into locations
...
(2,'Accounting Manager',8200.000,16000.00),
...
(11,'Marketing Representive',4000.00,9000.00),
...
(18,'Stock Clerk',2000.00,500.00),
(19,'Stock Manager',5500.00,8500.00),
(20,'Data analyst',20000.00,50000.00);
...
-- inserting values into the depertment table
...
INSERT INTO employees VALUES
    ...
    (101,'Neena','Kochhar','neena.kochhar@sqltutorial.org','123.456.7890','1989-09-21',5,17000.00,100,9),
    (102,'Lex','DeHaan','lex.dehaan@sqltutorial.org','111.222.3333','1993-01-13',5,17000.00,100,9),
    (103,'Alexander','Hunold','alexander.hunold@sqltutorial.org','098.765.4321','1990-01-03',9,9000.00,102,6),
    (104,'Bruce','Ernst','bruce.ernst@sqltutorial.org','111.222.4444','1991-05-21',9,6000.00,103,6),
...
-- 1.Retrieve all employee names (first_name, last_name) and their salaries.
SELECT first_name,last_name,salary FROM employees;

-- 2.Show the job title and salary range of each job from the jobs table. 
SELECT job_title,min_salary,max_salary FROM jobs;

-- 3.List all department names from the departments table 
SELECT department_name FROM departments;

-- 4.Display the names of dependents of employee with employee_id = 101
SELECT first_name,last_name FROM dependents
WHERE employee_id=101;

-- 5.Show the list of countries along with their region IDs.
SELECT country_name,region_id FROM countries;

-- intermediate level
-- 6.Find employees who earn more than 10,000.
SELECT * FROM employees
WHERE salary>10000;

-- 7.Show employees along with their department names 
SELECT employees.first_name,employees.last_name,departments.department_name FROM employees
JOIN departments ON employees.department_id=departments.department_id;

-- 8.Display employees who work in the IT department. 
SELECT employees.first_name,employees.last_name,departments.department_name FROM employees
JOIN departments ON employees.department_id=departments.department_id
WHERE departments.department_name='IT';

-- 9.Find employees whose job title is 'Sales Manager' 
